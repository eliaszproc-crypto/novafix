...
<div class="admin-card">
    <div class="admin-card__header">
        ...
        <a href="/admin/zgloszenia" class="btn btn--ghost btn--sm">Zobacz wszystkie</a>
    </div>
    <?php if (empty($recent)): ?>
        <p style="color:var(--tm);text-align:center;padding:32px">Brak zgłoszeń.</p>
    <?php else: ?>
    <div class="admin-table-wrap">
        <table class="admin-table">
            <thead><tr><th>RMA</th><th>Klient</th><th>Urządzenie</th><th>Status</th><th>Data</th><th></th></tr></thead>
            <tbody>
