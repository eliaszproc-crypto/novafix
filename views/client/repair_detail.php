    ...
    <div class="container">
        <div class="panel-header">
            <div>
                ...
                <div class="repair-status-badge" style="background:<?= $repair['status_color'] ?>22;color:<?= $repair['status_color'] ?>;border-color:<?= $repair['status_color'] ?>44">
                    <span class="status-dot" style="background:<?= $repair['status_color'] ?>"></span>
                    <?= sanitize($repair['status_label']) ?>
                </div>
            </div>
            <a href="/panel/zgloszenia" class="btn btn--ghost">← Wróć</a>
        </div>
            ...
            <div class="detail-main">
                <div class="panel-card">
                    ...
                    <div class="detail-rows">
                        <div class="detail-row"><span>Typ</span><strong><?= sanitize($repair['device_type']) ?></strong></div>
