...
class ClientController {
    ...
    public function sendMessage(string $id): void {
        ...
        $body = '<html><body style="font-family:Arial,sans-serif;background:#070d1a;color:#e2e8f4;padding:20px">'
            ...
            . '<p style="margin:4px 0 0;color:rgba(255,255,255,0.6);font-size:13px">Zlecenie: <strong style="color:#00e5ff">' . htmlspecialchars($rma) . '</strong></p>'
            . '</div>'
            . '<div style="padding:20px 24px">'
            . '<p style="color:#94a3b8;font-size:13px;margin-bottom:8px">Od: <strong style="color:#fff">' . htmlspecialchars($user_name) . '</strong></p>'
